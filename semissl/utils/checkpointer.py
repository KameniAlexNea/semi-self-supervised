...
class Checkpointer(Callback):
    ...
    def initial_setup(self, trainer: pl.Trainer):
        ...
        if version is not None:
            ...
            self.ckpt_placeholder = (
                f"{self.args.name}" + "-task{}-ep={}" + f"-{version}.ckpt"
            )
    ...
    def save_args(self, trainer: pl.Trainer):
        ...
        if trainer.is_global_zero:
            ...
            json.dump(
                args, open(self.json_path, "w"), default=lambda o: "<not serializable>"
            )
    ...
    def save(self, trainer: pl.Trainer):
        ...
        if trainer.is_global_zero and not trainer.sanity_checking:
            ...
            if (
                ...
                and not self.keep_previous_checkpoints
            ):
