...
from semissl.utils.kmeans import KMeans
...
class DeepClusterV2(BaseModel):
    ...
    def add_model_specific_args(
        ...
        parent_parser = super(DeepClusterV2, DeepClusterV2).add_model_specific_args(
            parent_parser
        )
        ...
        parser.add_argument(
            "--num_prototypes", type=int, nargs="+", default=[3000, 3000, 3000]
        )
    ...
    def on_train_start(self):
        ...
        self.register_buffer(
            ...
            F.normalize(
                torch.randn(self.num_crops, size_memory_per_process, self.output_dim),
                dim=-1,
            ).to(self.device, non_blocking=True),
        )
    ...
    def training_step(self, batch: Sequence[Any], batch_idx: int) -> torch.Tensor:
        ...
        out.update(
            {"loss": out["loss"] + deepcluster_loss, "z": [z1, z2], "p": [p1, p2]}
        )
        return out
