...
from semissl.methods.base import BaseMomentumModel
from semissl.utils.gather_layer import gather
...
class MoCoV2Plus(BaseMomentumModel):
    ...
    def add_model_specific_args(
        ...
        parent_parser = super(MoCoV2Plus, MoCoV2Plus).add_model_specific_args(
            parent_parser
        )
