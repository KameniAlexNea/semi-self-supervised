...
from semissl.utils.linearwarnupcosine import LinearWarmupCosineAnnealingLR
from torch.optim.lr_scheduler import CosineAnnealingLR
from torch.optim.lr_scheduler import MultiStepLR

from semissl.utils.knn import WeightedKNNClassifier
from semissl.utils.lars import LARSWrapper
from semissl.utils.metrics import accuracy_at_k
from semissl.utils.metrics import weighted_mean
from semissl.utils.momentum import MomentumUpdater
from semissl.utils.momentum import initialize_momentum_params
...
class BaseMomentumModel(BaseModel):
    ...
    def training_step(self, batch: List[Any], batch_idx: int) -> Dict[str, Any]:
        ...
        outs_task = {
            "momentum_" + k: [out[k] for out in outs_task] for k in outs_task[0].keys()
        }
        ...
        if self.online_eval:
            *_, X_online_eval, targets_online_eval = batch["online_eval"]
            ...
            outs_online_eval = {
                "online_eval_momentum_" + k: v for k, v in outs_online_eval.items()
            }
