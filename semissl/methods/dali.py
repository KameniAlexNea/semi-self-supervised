...
from semissl.utils.dali_dataloader import CustomNormalPipeline
from semissl.utils.dali_dataloader import CustomTransform
from semissl.utils.dali_dataloader import ImagenetTransform
from semissl.utils.dali_dataloader import MulticropPretrainPipeline
from semissl.utils.dali_dataloader import NormalPipeline
from semissl.utils.dali_dataloader import PretrainPipeline
...
class PretrainABC(ABC):
    ...
    def train_dataloader(self) -> DALIGenericIterator:
        ...
        if self.multicrop:
            ...
            transforms = []
            for size, min_scale, max_scale in zip(
                size_crops, min_scales, max_scale_crops
            ):
        ...
        conversion_map = (
            train_pipeline.conversion_map if self.encode_indexes_into_labels else None
        )
